...
class qBMP {
 ...
 qBMP(std::string str1) {
  //load picture
  xSurface = SDL_LoadBMP( str1.c_str() );
  printf("qBMP()");
 }
...
// ===================== INIT =============================================
 ...
 {
  //Create window
  window = SDL_CreateWindow( "window 2", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
  if( window == NULL )
  {
