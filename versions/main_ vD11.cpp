    ...
    while( SDL_PollEvent( &e ) != 0 )
    {
     ...
     if( e.type == SDL_QUIT )
     {
      ...
      switch( e.key.keysym.sym )
      {
       ...
       case SDLK_2:
        printf(" key2 - display \n");
        SDL_BlitSurface( xHi.xSurface, NULL, screenSurface, NULL );
        rd->x = (unsigned int)man1.x;
        rd->y = 32;
        SDL_BlitSurface( xHi.xSurface, rs, screenSurface, rd );
        SDL_UpdateWindowSurface( window );
        break;
       case SDLK_3:
        printf(" key3 - display \n");
        SDL_BlitSurface( xAloha.xSurface, NULL, screenSurface, NULL );
        SDL_UpdateWindowSurface( window );
        break;
       case SDLK_4:
        printf(" key4 - display \n");
        SDL_BlitSurface( xBlack.xSurface, NULL, screenSurface, NULL );
        SDL_UpdateWindowSurface( window );
        break;
       ...
       case SDLK_LEFT:
         SDL_BlitSurface( xBlack.xSurface, NULL, screenSurface, rd );
        man1.x-=5;
